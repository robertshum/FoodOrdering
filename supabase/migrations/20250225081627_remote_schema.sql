...
CREATE POLICY "All auth. All operations" ON "public"."order_items" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "All auth. users All operations" ON "public"."orders" TO "authenticated" USING (true) WITH CHECK (true);
